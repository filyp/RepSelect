...
common="run python src/unlearn_relearn.py --config-name=unlearn.yaml --multirun experiment=unlearn/rwku/default model=${model}"
prefix="${version}_${model}_rwku"
...
# (no ${prefix}_reference run: the baseline_rwku_${model} runs from
